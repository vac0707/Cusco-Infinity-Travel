...
export const PACKAGES: Package[] = [
  {
    ...
    excludes: ['Boleto Turístico', 'Entrada Qoricancha'],
    itinerary: [
  ...
  },
  {
    ...
    price: 350,
    difficulty: 'Moderado',
    includes: ['Desayuno y Almuerzo', 'Servicio de guiado', 'Transporte turístico', 'Traslado al aeropuerto'],
  ...
  {
    id: 'cusco-mistico',
    title: 'Cusco Místico 4 en 1',
    duration: 'Medio Día',
    places: ['Morada de los Dioses', 'Valle de los Duendes', 'Humedal de Huasao'],
    price: 350,
    difficulty: 'Fácil',
    includes: ['Transporte turístico', 'Servicio de guiado', 'Boletos a Morada de los Dioses'],
  ...
  },
  {
    ...
    price: 550,
    difficulty: 'Desafiante',
    includes: ['Transporte turístico', 'Desayuno y Almuerzo local', 'Guía profesional bilingüe', 'Botiquín'],
  ...
  },
  {
    ...
    title: 'Montaña de Colores en Cuatrimoto',
    duration: '1 Día',
  ...
  },
  {
    ...
    title: 'Cuatrimotos en el Valle',
    duration: 'Medio Día',
    places: ['Laguna Huaypo', 'Maras'],
    price: 250,
    difficulty: 'Moderado',
    includes: ['Transporte turístico', 'Servicio de guía motorizado', 'Casco y botiquín', 'Cuatrimoto'],
